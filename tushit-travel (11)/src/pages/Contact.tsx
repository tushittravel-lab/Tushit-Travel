          ...
          >
            ...
            <form 
              onSubmit={(e) => {
                ...
                const whatsappMsg = `*New Contact Inquiry - Tushit Travel*%0A%0A*Name:* ${name}%0A*Phone:* ${phone}%0A*Email:* ${email}%0A*Subject:* ${subject}%0A*Message:* ${message}`;
                window.open(`https://wa.me/919074444467?text=${whatsappMsg}`, '_blank');
              }}
